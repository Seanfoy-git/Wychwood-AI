...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">The real problem is not usually the model</h2>
...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">Why this happens in scaling companies</h2>
...
<h3 class="mt-10 text-2xl font-semibold tracking-tight text-[rgb(var(--text))]">Core entities are not consistently defined</h3>
...
<h3 class="mt-10 text-2xl font-semibold tracking-tight text-[rgb(var(--text))]">Metrics do not mean the same thing everywhere</h3>
...
<h3 class="mt-10 text-2xl font-semibold tracking-tight text-[rgb(var(--text))]">Decision rights are unclear</h3>
...
<h3 class="mt-10 text-2xl font-semibold tracking-tight text-[rgb(var(--text))]">Workflows are unstable</h3>
...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">Why pilots succeed but scaling fails</h2>
...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">The missing prerequisite: an operational context layer</h2>
...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">What most companies get wrong</h2>
...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">Wychwood point of view</h2>
...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">Related Concepts</h2>
...
<h2 class="mt-14 text-3xl font-semibold tracking-tight text-[rgb(var(--text))]">Sources</h2>
