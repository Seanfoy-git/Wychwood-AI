...
- **[Operational Context Layer](/concepts/operational-context-layer)** — the semantic and governance layer that defines how business entities, metrics, and systems relate.

- **[Company Operating System](/frameworks/operating-system)** — the execution architecture that aligns metrics, decision rights, and operating cadence.
